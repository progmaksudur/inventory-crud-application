...
import 'package:inventory_crud_application/domain/models/base_model/error_response.dart';
          ...
          switch (error.type) {
            ...
            case DioErrorType.response:
              switch (error.response!.statusCode) {
                case 404:
                case 500:
                errorDescription = "Failed to load data -  ${error.response!.statusCode}";
                break;
                case 422:
                errorDescription = "Failed to load data -  ${error.response!.data['message']}";
                  break;
                case 503:
